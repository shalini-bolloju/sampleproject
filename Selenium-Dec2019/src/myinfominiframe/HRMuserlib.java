...
public class HRMuserlib {
	...
	public static void deleteDependent(){
        ...
        for(int i=1;i<=rowCount;i++)
        {
        String childname1=driver.findElement(By.xpath("//table[@id='dependent_list']/tbody/tr["+i+"]/td[2]/a")).getText();
	    String childdob1=driver.findElement(By.xpath("//table[@id='dependent_list']/tbody/tr["+i+"]/td[4]")).getText();
		if((childname1.contains("santhosh"))&&(childdob1.contains("2015-01-29")))
		{
